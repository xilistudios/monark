...
fn test_is_valid_signature_valid() {
    ...
    assert_eq!(crate::io::signature::is_valid_signature(valid_sig), true);
}

#[test]
fn test_is_valid_signature_invalid() {
    let invalid_sig = "invalid/signature";
    assert_eq!(crate::io::signature::is_valid_signature(invalid_sig), false);
}

#[test]
fn test_sign_content() {
    let content = "test content";
    let signed = crate::io::signature::sign_content(content);
...
fn test_parse_content_valid() {
    ...
    let parsed = crate::io::signature::parse_content(signed_content);
...
fn test_parse_content_malformed() {
    ...
    let parsed = crate::io::signature::parse_content(malformed_content);
