    ...
    <section>
      ...
      <details className="group mt-6">
        <summary className="flex items-center justify-between p-4 bg-base-50 border border-base-200 rounded-xl cursor-pointer hover:bg-base-100 transition-colors duration-200 list-none">
          ...
          <svg className="w-5 h-5 text-base-content/60 group-open:rotate-180 transition-transform duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ol className="space-y-2 text-sm text-base-content/70">
              <li className="flex gap-3">
                <span className="w-5 h-5 flex items-center justify-center bg-primary/10 text-primary text-xs font-medium rounded-full shrink-0">1</span>
                {t(
              ...
              <li className="flex gap-3">
                <span className="w-5 h-5 flex items-center justify-center bg-primary/10 text-primary text-xs font-medium rounded-full shrink-0">2</span>
                {t(
              ...
              <li className="flex gap-3">
                <span className="w-5 h-5 flex items-center justify-center bg-primary/10 text-primary text-xs font-medium rounded-full shrink-0">3</span>
                {t(
              ...
              <li className="flex gap-3">
                <span className="w-5 h-5 flex items-center justify-center bg-primary/10 text-primary text-xs font-medium rounded-full shrink-0">4</span>
                {t(
              ...
              <li className="flex gap-3">
                <span className="w-5 h-5 flex items-center justify-center bg-primary/10 text-primary text-xs font-medium rounded-full shrink-0">5</span>
                {t(
