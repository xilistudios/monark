...
export function LockedVaultView({
	...
	return (
		<div
			data-testid="locked-vault-view"
			className={`h-full flex flex-col items-center justify-center transition-opacity duration-300 ${isVisible ? "opacity-100" : "opacity-0"}`}
		>
