...
export const OAuthFlow = ({
	...
	const decodeBase64Payload = (input: string) => {
	...
	const handleImportBase64 = async () => {
		try {
			...
			const rawInput = base64Input.trim();

			// Accept either raw JSON or base64/base64url payloads.
			const jsonString = rawInput.startsWith("{")
				? rawInput
				: decodeBase64Payload(rawInput);
