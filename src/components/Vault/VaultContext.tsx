...
import { selectOAuthState } from "../../redux/selectors/vaultSelectors";
...
interface VaultModalState {
	...
	/** Whether the add provider modal is open */
...
const VaultModalProvider: React.FC<VaultModalProviderProps> = ({
	...
	const handleOAuthError = (error: string) => {
		console.error("[VaultModalProvider] OAuth error:", error);
		if (oauthState.providerName) {
			dispatch(
				setProviderStatus({
					providerId: oauthState.providerName,
