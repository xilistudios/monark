...
export const loadPreferencesFromSettings = async (): Promise<Partial<PreferencesState>> => {
  try {
...
export const preferencesSlice = createSlice({
  ...
  reducers: {
    ...
    restorePreferencesState: (state, action: PayloadAction<Partial<PreferencesState>>) => {
