...
describe('SettingsStore', () => {
  ...
  describe('Get Method', () => {
    ...
    it('should throw error when store is not initialized', async () => {
      ...
      await expect(uninitializedStore.get('testKey')).rejects.toThrow('Store not initialized')
    })
    ...
    it('should handle store get errors', async () => {
      ...
      await expect(settingsStore.get('testKey')).rejects.toThrow('Store get failed')
    })
  })
  ...
  describe('Set Method', () => {
    ...
    it('should throw error when store is not initialized', async () => {
      ...
      await expect(uninitializedStore.set('testKey', 'value')).rejects.toThrow('Store not initialized')
    })
    ...
    it('should handle store set errors', async () => {
      ...
      await expect(settingsStore.set('testKey', 'value')).rejects.toThrow('Store set failed')
    })
  ...
  describe('Remove Method', () => {
    ...
    it('should throw error when store is not initialized', async () => {
      ...
      await expect(uninitializedStore.remove('testKey')).rejects.toThrow('Store not initialized')
    })
    ...
    it('should handle store delete errors', async () => {
      ...
      await expect(settingsStore.remove('testKey')).rejects.toThrow('Store delete failed')
    })
  })
  ...
  describe('Store Loading Failure', () => {
    it('should handle store loading failure gracefully', async () => {
      ...
      await expect(failingStore.get('key')).rejects.toThrow('Store not initialized')
      await expect(failingStore.set('key', 'value')).rejects.toThrow('Store not initialized')
      await expect(failingStore.remove('key')).rejects.toThrow('Store not initialized')
    })
  })
})
