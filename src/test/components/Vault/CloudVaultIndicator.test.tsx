...
describe('CloudVaultIndicator', () => {
  ...
  it('applies custom className correctly', () => {
    ...
    const indicator = screen.getByTitle('vaultSelector.localVault').closest('div');
  ...
  it('handles cloud vault without last sync gracefully', () => {
    ...
    expect(screen.queryByText('vaultSelector.lastSync:')).not.toBeInTheDocument();
  });
  ...
  describe('Performance and Edge Cases', () => {
    ...
    it('handles very long provider names', () => {
      const longProviderName = 'very-long-provider-name-that-might-cause-layout-issues';
