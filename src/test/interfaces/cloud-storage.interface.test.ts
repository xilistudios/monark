...
import {
	...
	type CloudStorageSearchParams,
	type CloudStorageSearchResponse,
	type CloudVaultMetadata,
	type CloudVaultOperation,
	type CreateCloudVaultRequest,
	type CreateFileRequest,
	type CreateFolderRequest,
	type DeleteCloudVaultRequest,
...
describe("Cloud Storage Interfaces", () => {
	...
	describe("CloudStorageErrorType", () => {
		it("should have all required error types", () => {
			expect(CloudStorageErrorType.AUTHENTICATION_FAILED).toBe(
			...
			expect(CloudStorageErrorType.PROVIDER_NOT_CONFIGURED).toBe(
				"PROVIDER_NOT_CONFIGURED",
			);
			expect(CloudStorageErrorType.INVALID_CREDENTIALS).toBe(
				"INVALID_CREDENTIALS",
			);
