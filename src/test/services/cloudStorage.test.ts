...
describe("CloudStorageCommands", () => {
	...
	describe("Provider Management", () => {
		...
		it("should remove provider successfully", async () => {
			...
			expect(mockInvoke).toHaveBeenCalledWith("remove_provider", {
				name: providerName,
			});
		});
		...
		it("should authenticate provider successfully", async () => {
			...
			expect(mockInvoke).toHaveBeenCalledWith("authenticate_provider", {
				providerName,
			});
		});
	});
	...
	describe("File Operations", () => {
		...
		it("should create file successfully", async () => {
			...
			const result = await CloudStorageCommands.createFile(
				request,
				"google-drive",
			);
		...
		it("should read file successfully", async () => {
			...
			const result = await CloudStorageCommands.readFile(
				fileId,
				"google-drive",
			);
		...
		it("should update file successfully", async () => {
			...
			const result = await CloudStorageCommands.updateFile(
				request,
				"google-drive",
			);
		...
		it("should create folder successfully", async () => {
			...
			const result = await CloudStorageCommands.createFolder(
				request,
				"google-drive",
			);
		...
		it("should get file info successfully", async () => {
			...
			const result = await CloudStorageCommands.getFileInfo(
				fileId,
				"google-drive",
			);
